<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmStudentPayment.aspx.cs" Inherits="frmStudentPayment" %>
        ...
        <div class="wrap-contact100">
            ...
            <form class="contact100-form" id="form1" runat="server">
                ...
                <div class="wrap-input100">
                    ...
                    <span class="focus-input100"></span>
                    <asp:RequiredFieldValidator class="text-danger" ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtemailID" ValidationGroup="b"
                     ErrorMessage="Please Enter Email ID" Font-Bold="False" InitialValue=""></asp:RequiredFieldValidator>
                ...
                <div class="wrap-input100">
                    ...
                    <span class="focus-input100"></span>
                    <asp:RequiredFieldValidator class="text-danger" ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtbanknm" ValidationGroup="b" 
                     ErrorMessage="Please Enter Bank Name" Font-Bold="False" InitialValue=""></asp:RequiredFieldValidator>
                ...
                <div class="wrap-input100">
                    ...
                    <span class="focus-input100"></span>
                    <asp:RequiredFieldValidator class="text-danger" ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtpayamt" ValidationGroup="b" 
                     ErrorMessage="Please Enter Payment Amount" Font-Bold="False" InitialValue=""></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="wrap-input100">
                    ...
                    <span class="focus-input100"></span>
                    <asp:RequiredFieldValidator class="text-danger" ID="RequiredFieldValidator3" runat="server"   ControlToValidate="txtpayamt" ValidationGroup="b" 
                     ErrorMessage="Please Enter Payment Amount" Font-Bold="False" InitialValue=""></asp:RequiredFieldValidator>
                      <asp:RegularExpressionValidator id="RegularExpressionValidator1" ControlToValidate="txtpayamt" ValidationExpression="\d+" Display="Static" ValidationGroup="b"
                ...
                <div class="wrap-input100">
                    ...
                    <span class="focus-input100"></span>
                    <asp:RequiredFieldValidator class="text-danger" ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtpayrefno" ValidationGroup="b"
                     ErrorMessage="Please Enter Payment Reference Number" Font-Bold="False" InitialValue=""></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="wrap-input100">
                    ...
                    <asp:RequiredFieldValidator class="text-danger" ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtRemark" ValidationGroup="b"
                     ErrorMessage="Please Enter Remark" Font-Bold="False" InitialValue=""></asp:RequiredFieldValidator>
					<span class="focus-input100"></span>
                </div>
