<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmMarkEntryPrimary.aspx.cs" Inherits="frmMarkEntryPrimary" %>
...
<asp:TabContainer ID="TabContainer1" CssClass="MyTabStyle" runat="server" Width="1250px"
      ...
      <asp:TabPanel ID="TabPanel7" runat="server" HeaderText="TabPanel2" Visible="false">
     ...
     <asp:TabPanel ID="TabPanel8" runat="server" HeaderText="TabPanel2" Visible="false" >
                                <HeaderTemplate>Social Habbit</HeaderTemplate>
                                ...
                                <HeaderTemplate>Art Music Hand Writting</HeaderTemplate>
