...
public partial class MarksEntry1to5 : DBUtility
{
        ...
        try
        {
            ...
            if (ddlExam1.SelectedValue != "0" && ddlExam1.SelectedValue != "")
            {
                ...
                for (int i = 0; i < CountSubject; i++)
                {
                    ...
                    GridView2.Columns[i + 3].HeaderText = Convert.ToString(dsObj.Tables[0].Rows[i]["VchName"]);
                    GridView2.Columns[i + 3].HeaderStyle.HorizontalAlign = HorizontalAlign.Center;
                ...
                for (int i = GridView2.Columns.Count - 1; i > CountSubject + 2; i--)
                {
        ...
        try
        {
            ...
            if (dsObj.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < GridView2.Rows.Count; i++)
                {
                    for (int k = 0; k < dsObj.Tables[0].Rows.Count; k++)
                    {
                        subjectId = Convert.ToInt32((GridView2.Columns.Count - 1) / 2) + 1;
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                for (int j = 1; j < (GridView1.Columns.Count / 2); j++)
                {
                   ...
                   // {
                        ...
                        string view = ddlExam1.SelectedValue.ToString();
                        int view1 = int.Parse(view);
                        if (view1 == 15 || view1 == 11 || view1 == 23 || view1 == 19 || view1 == 31 || view1 == 27 || view1 == 39 || view1 == 35 || view1 == 47 || view1 == 43 || view1 == 99 || view1 == 7 || view1 == 101 || view1 == 2 || view1 == 103 || view1 == 4 || view1 == 57 || view1 == 53 || view1 == 69 || view1 == 73 || view1 == 65 || view1 == 61)
    ...
    protected void btncopyElementes_Click(object sender, EventArgs e)
    {
        try
        {
            strQry = "exec usp_ExamMarks @type='GetHalfyearlyID',@intStandard_id='" + Convert.ToString(ddlSTD1.SelectedValue) + "'";
            dsObj = sGetDataset(strQry);
            int intExam_id = Convert.ToInt32(dsObj.Tables[0].Rows[0]["intExam_id"]);
            CopyFillElementsMarksDataGrid(intExam_id);
        }
        catch
        {
        }
    ...
    public void CopyFillElementsMarksDataGrid(int intExam_id)
    {
        try
        {
            //strQry = "exec usp_FillDropDown @type='GetStudents',@intDiv_id='" + Convert.ToString(ddlDIV1.SelectedValue) + "',@vchGender='" + Convert.ToString(ddlGender.SelectedItem.Text) + "',@intSchool_id='" + Session["School_id"] + "'";
            ...
            strQry = "exec usp_ExamMarks @type='FillElementsMark',@intExam_id='" + intExam_id + "',@intstandard_id='" + ddlSTD1.SelectedValue + "',@intAcademic_id='" + Convert.ToString(Session["AcademicID"]) + "'";
            dsObj = sGetDataset(strQry);
            if (dsObj.Tables[0].Rows.Count > 0)
            {
                //SubMaxMarks.Value = Convert.ToString(dsObj.Tables[0].Rows[0]["intMaxMark"]);
