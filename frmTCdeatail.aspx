<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmTCdeatail.aspx.cs" Inherits="frmTCdeatail" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>Detail Transfer Certificate</title>
...
<%--                                                    <td align="left" valign="middle">
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td align="center" valign="middle">
                                                    <asp:Label ID="lblcount" runat="server" CssClass="textsize" Visible="False" 
            ...
            CssClass="table  tabular-table " DataKeyNames="SRNo,intStudent_id" 
