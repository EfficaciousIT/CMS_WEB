<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="FrmAdmTeacherProfile.aspx.cs" Inherits="FrmAdmTeacherProfile" Title="Teacher Profile"
    Culture="es-MX" %>
...
<div class="content-header content-header1 pd-0">
        ...
        <li><a >School Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="FrmAdmTeacherProfile.aspx">Teacher Master</a></li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Button runat="server" Text="Next" ID="ButN1" OnClick="checknextval1" CssClass="btn"
                                                                Style="position: relative; " ValidationGroup="a1"></asp:Button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </center>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intTeacher_id" onrowediting="grvDetail_RowEditing" OnRowDeleting="grvDetail_RowDeleting" >
                                                                <Columns>
