<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Result_VI-VIII.aspx.cs" Inherits="Result_VI_VIII" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding-right: 0px" valign="middle">
                                                        <asp:DropDownList ID="ddlSTD" runat="server" AutoPostBack="True" CssClass="textsize"
                                                            ...
                                                            <asp:ListItem Value="7" Text="VII"></asp:ListItem>
                                                            <asp:ListItem Value="8" Text="VIII"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td align="center" valign="middle">
