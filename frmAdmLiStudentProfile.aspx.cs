...
public partial class frmAdmLiStudentProfile : DBUtility
{
                    ...
                    txt15.Text = Convert.ToString(dsObj.Tables[0].Rows[0]["vchAddress"]);
                     ...
                     string src11 = Convert.ToString(dsObj.Tables[0].Rows[0]["vchImageURL"]);
                            ...
                            String savePath = "~/images/Profile/Students/";
                                ...
                                txtDrName.Text = Convert.ToString(dsObj.Tables[0].Rows[0]["vchDoctor_name"]);
                                txtDrNumber.Text = Convert.ToString(dsObj.Tables[0].Rows[0]["intDoctorConNo"]);
                                ...
                                if (Convert.ToString(dsObj.Tables[0].Rows[0]["vchPassport"]) == "")
                                {
                                    txt49.Text = "";
                                    txt50.Text = "";
                                }
                                ...
                                {
                                    txt49.Text = Convert.ToDateTime(dsObj.Tables[0].Rows[0]["dtpassportissue"]).ToString("MM/dd/yyyy"); ;
                                    txt50.Text = Convert.ToDateTime(dsObj.Tables[0].Rows[0]["dtexpiredate"]).ToString("MM/dd/yyyy"); ;
                                }
    ...
    protected void submit(object sender, EventArgs e)
    {
        try
        {
           ...
           // string filnmn = ViewState["Filename"].ToString();
            ...
            string DrName = Convert.ToString(txtDrName.Text);
            string DrNumber = Convert.ToString(txtDrNumber.Text);
            ...
            string instrquery1 = "Execute dbo.usp_Profile @command='InsertStudentProfile',@intstanderd_id='" + StandId + "',@intDivision_id='" + DiviId + "',@intRollNo='" + rollno + "',@vchStudentFirst_name='" + Fname + "',@vchStudentMiddle_name='" + Mname + "'," +
                                  "@vchStudentLast_name='" + lname + "',@vchFatherName='" + Fathername + "',@vchMotherName='" + Mothername + "',@vchGender='" + gender + "',@dtDOB='" + Dobnm + "',@vchplaceofBirth='" + Placebt + "',@dtActivationDate='" + insertdt + "',@vchActivestatus=1,@intActivationBy='" + Session["User_id"] + "'," +
                                   "@vchCast='" + cast + "',@vchsubcast='" + subcast + "',@vchEmail='" + Emailid + "',@vchMothertongue='" + mothertounge + "',@vchpresentAddress='" + Preadd + "',@vchpermanentAddress='" + paradd + "',@vchImageURL='" + filnmn + "',@intHomePhoneNo1='" + homete1 + "',@intHomePhoneNo2='" + homete2 + "',@vchEmergencyConPerson1='" + cont1 + "',@intEmergencyContat1='" + conno1 + "',@vchEmergencyConPerson2='" + con2 + "'," +
                                    "@intEmergencyContat2='" + conno2 + "',@vchNeighbour_name='" + Neighnm + "',@intNeighborConNo='" + neino + "',@vchDoctor_name='" + DrName + "',@intDoctorConNo='" + DrNumber + "',@chrBloodGrp='" + Bloodgp + "',@vchPassport='" + passportno + "',@dtpassportissue='" + Dateofissue + "',@dtexpiredate='" + DateofExpire + "',@vchHandicapedStatus='" + healthdis + "',@vchDescription='" + Descip + "',@vchaadhar_no='" + aadhar2 + "',@vchPanCard='" + Panno1 + "',@intBusAlert1='" + alert1 + "',@intBusAlert2='" + alert2 + "'";
    ...
    protected void Update1(object sender, EventArgs e)
    {
        try
        {
            ...
            string  mothno=null;
                if (txt12.Text != "")
            {
                  Telno = Convert.ToString(txt12.Text);
            }
            if (txt13.Text != "")
            {
                mothno = Convert.ToString(txt13.Text);
            }
            if (txt14.Text != "")
            {
                fathno = Convert.ToString(txt14.Text);
            }
            ...
            if (txt43.Text != "")
            {
                 neino = Convert.ToString(txt43.Text);
            ...
            if (!String.IsNullOrEmpty(txt50.Text))
                ...
                DateofExpire = Convert.ToDateTime(txt50.Text).ToString("MM/dd/yyyy");
            string mothertounge = Convert.ToString(txt51.Text);
             string Panno = Convert.ToString(txt54.Text);
             string Adharno = Convert.ToString(txt55.Text);
            string Bus1 = Convert.ToString(txt52.Text);
            string Bus2 = Convert.ToString(txt53.Text);
            string TelNo = Convert.ToString(txt12.Text);
            string FathMo = Convert.ToString(txt13.Text);
            string MothMo = Convert.ToString(txt14.Text);
            ...
            string instrquery1 = "Execute dbo.usp_Profile @command='UpdateStudentProfile',@intstanderd_id='" + StandId + "',@intDivision_id='" + DiviId + "',@intRollNo='" + rollno + "',@vchStudentFirst_name='" + Fname + "',@vchStudentMiddle_name='" + Mname + "'," +
                                  "@vchStudentLast_name='" + lname + "',@vchFatherName='" + Fathername + "',@vchMotherName='" + Mothername + "',@vchGender='" + gender + "',@dtDOB='" + Dobnm + "',@vchplaceofBirth='" + Placebt + "',@dtActivationDate='" + insertdt + "',@vchActivestatus=1,@intActivationBy='" + Session["User_id"] + "'," +
                                   "@vchCast='" + cast + "',@vchsubcast='" + subcast + "',@vchEmail='" + Emailid + "',@vchMothertongue='" + mothertounge + "',@vchpresentAddress='" + Preadd + "',@vchpermanentAddress='" + paradd + "',@vchImageURL='" + filnmn + "',@intHomePhoneNo1='" + homete1 + "',@intHomePhoneNo2='" + homete2 + "',@vchEmergencyConPerson1='" + cont1 + "',@intEmergencyContat1='" + conno1 + "',"+
                                   "@vchEmergencyConPerson2='" + con2 + "',@intEmergencyContat2='" + conno2 + "',@vchNeighbour_name='" + Neighnm + "',@intNeighborConNo='" + neino + "',@vchDoctor_name='" + DrName + "',@intDoctorConNo='" + DrNumber + "',@chrBloodGrp='" + Bloodgp + "',@vchPassport='" + passportno + "',@dtpassportissue='" + Dateofissue + "',@dtexpiredate='" + DateofExpire + "',@vchHandicapedStatus='" + healthdis + "',@vchDescription='" + Descip + "'," +
                                   "@intUpdate_id='" + intUpdate_id + "',@vchUpdated_IP='" + vchUpdated_IP + "',@intschool_id='" + Session["school_id"] + "',@intstudent_id='" + idv1.Text + "',@vchPanCard='" + Panno + "',@intBusAlert1='" + Bus1 + "',@intBusAlert2='" + Bus2 + "',@vchaadhar_no='" + Adharno + "',@intTelNo1='"+TelNo+"',@intFatherMobile='"+FathMo+"',@intMotherMobile='"+MothMo+"'";
