    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["rptAllStudentMark"] != null)  
        {
            ...
            try
            {
                ...
                {
                    strQry = "select count(intExamSubject_id) from tblExamSubject_Master where intStandard_id='" + Convert.ToString(Session["standard_idnum"]) + "' and intactive_flg=1 and intAcademic_id='" + Session["AcademicID"] + "' ";
                    ...
                    if (count == 11)
                    {
                        ...
                        if (Convert.ToString(Session["standard_id"]) == "XI Sc" || Convert.ToString(Session["standard_id"]) == "XI Com" || Convert.ToString(Session["standard_id"]) == "XI Arts") 
                        {
                            ...
                            string reportPath = Server.MapPath("rptResult11Arts.rpt");
                            ...
                            TextObject SUBEng = (TextObject)crystalReport.ReportDefinition.Sections["Section3"].ReportObjects["Text51"];
                            TextObject SUBHindiBengali = (TextObject)crystalReport.ReportDefinition.Sections["Section3"].ReportObjects["Text52"];
                            ...
                            TextObject HYEntrepreneurship = (TextObject)crystalReport.ReportDefinition.Sections["Section3"].ReportObjects["Text41"];
                            TextObject HYSUB11 = (TextObject)crystalReport.ReportDefinition.Sections["Section3"].ReportObjects["Text45"];

                            TextObject PRHYEng = (TextObject)crystalReport.ReportDefinition.Sections["Section3"].ReportObjects["Text122"];
                            TextObject PRHYHindiBengali = (TextObject)crystalReport.ReportDefinition.Sections["Section3"].ReportObjects["Text35"];
                            ...
                            TextObject PRHYMath = (TextObject)crystalReport.ReportDefinition.Sections["Section3"].ReportObjects["Text32"];
                            ...
                            string HYEntrepreneurshipstring = "";
                            ...
                            for (i = 0; i < dsObjgrade.Tables[0].Rows.Count; i++)
                            {
                                ...
                                if (dsObj.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    try
                                    {
                                        HYEntrepreneurship.Text = Convert.ToString(dsObj.Tables[0].Rows[9]["Half Yearly"]);
                                        if (HYEntrepreneurship.Text == "NA" || HYEntrepreneurship.Text == "AB")
                                        {
                                            HYEntrepreneurshipstring = "0";
                                        }
                                        else
                                        {
                                            HYEntrepreneurshipstring = HYEntrepreneurship.Text;
                                        }
                                    }
                                    catch
                                    {
                                    ...
                                    try
                                    {
                                        HYSUB11.Text = Convert.ToString(dsObj.Tables[0].Rows[9]["Half Yearly"]);
                                    ...
                                    try
                                    {
                                        PRHYSUB11.Text = Convert.ToString(dsObj.Tables[0].Rows[9]["HYPractical"]);
                                    ...
                                    try
                                    {
                                        //UTITOT.Text = Convert.ToString(Convert.ToInt32(UTEng.Text) + Convert.ToInt32(UTHindiBengali.Text) + Convert.ToInt32(UTPhysics.Text) + Convert.ToInt32(UTChemistry.Text) + Convert.ToInt32(UTBiology.Text) + Convert.ToInt32(UTCompSci.Text) + Convert.ToInt32(UTMath.Text) + Convert.ToInt32(UTPhysicalEdu.Text) + Convert.ToInt32(UTCommercialArt.Text));HYEntrepreneurship
                                        HYTOT.Text = Convert.ToString(Convert.ToInt32(HYEngstring) + Convert.ToInt32(HYHindiBengalistring) + Convert.ToInt32(HYPhysicsstring) + Convert.ToInt32(HYChemistrystring) + Convert.ToInt32(HYBiologystring) + Convert.ToInt32(HYCompScistring) + Convert.ToInt32(HYMathstring) + Convert.ToInt32(HYPhysicalEdustring) + Convert.ToInt32(HYCommercialArtstring) + Convert.ToInt32(HYEntrepreneurshipstring) + Convert.ToInt32(HYSUB11string) + Convert.ToInt32(PRHYEngstring) + Convert.ToInt32(PRHYHindiBengalistring) + Convert.ToInt32(PRHYPhysicsstring) + Convert.ToInt32(PRHYChemistrystring) + Convert.ToInt32(PRHYBiologystring) + Convert.ToInt32(PRHYCompScistring) + Convert.ToInt32(PRHYMathstring) + Convert.ToInt32(PRHYPhysicalEdustring) + Convert.ToInt32(PRHYCommercialArtstring) + Convert.ToInt32(PRHYEntrepreneurshipstring) + Convert.ToInt32(PRHYSUB11string));
                                        // HYTOT.Text = Convert.ToString(Convert.ToInt32(HYEngstring) + Convert.ToInt32(HYHindiBengalistring) + Convert.ToInt32(HYPhysicsstring) + Convert.ToInt32(HYChemistrystring) + Convert.ToInt32(HYBiologystring) + Convert.ToInt32(HYCompScistring) + Convert.ToInt32(HYMathstring) + Convert.ToInt32(HYPhysicalEdustring) + Convert.ToInt32(HYCommercialArtstring)  + Convert.ToInt32(PRHYEngstring) + Convert.ToInt32(PRHYHindiBengalistring) + Convert.ToInt32(PRHYPhysicsstring) + Convert.ToInt32(PRHYChemistrystring) + Convert.ToInt32(PRHYBiologystring) + Convert.ToInt32(PRHYCompScistring) + Convert.ToInt32(PRHYMathstring) + Convert.ToInt32(PRHYPhysicalEdustring) + Convert.ToInt32(PRHYCommercialArtstring) );
                                    }
                                    catch
                                    {
                                    }
                                ...
                                crystalReport.Load(Server.MapPath(string.Format("rptResult11Arts.rpt", i)));
                        ...
                        if (Convert.ToString(Session["standard_id"]) == "XI Sc" || Convert.ToString(Session["standard_id"]) == "XI Com" || Convert.ToString(Session["standard_id"]) == "XI Arts") //Convert.ToString(Session["standard_id"]) == "XI Sc" || Convert.ToString(Session["standard_id"]) == "XI Com" ||
                        {
                            ...
                            for (i = 0; i < dsObjgrade.Tables[0].Rows.Count; i++)
                            {
                                ...
                                if (dsObj.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    {
                                        //UTITOT.Text = Convert.ToString(Convert.ToInt32(UTEng.Text) + Convert.ToInt32(UTHindiBengali.Text) + Convert.ToInt32(UTPhysics.Text) + Convert.ToInt32(UTChemistry.Text) + Convert.ToInt32(UTBiology.Text) + Convert.ToInt32(UTCompSci.Text) + Convert.ToInt32(UTMath.Text) + Convert.ToInt32(UTPhysicalEdu.Text) + Convert.ToInt32(UTCommercialArt.Text));HYEntrepreneurship
                                        HYTOT.Text = Convert.ToString(Convert.ToInt32(HYEngstring) + Convert.ToInt32(HYHindiBengalistring) + Convert.ToInt32(HYPhysicsstring) + Convert.ToInt32(HYChemistrystring) + Convert.ToInt32(HYBiologystring) + Convert.ToInt32(HYCompScistring) + Convert.ToInt32(HYMathstring) + Convert.ToInt32(HYPhysicalEdustring) + Convert.ToInt32(HYCommercialArtstring) + Convert.ToInt32(HYEntrepreneurshipstring)  + Convert.ToInt32(PRHYEngstring) + Convert.ToInt32(PRHYHindiBengalistring) + Convert.ToInt32(PRHYPhysicsstring) + Convert.ToInt32(PRHYChemistrystring) + Convert.ToInt32(PRHYBiologystring) + Convert.ToInt32(PRHYCompScistring) + Convert.ToInt32(PRHYMathstring) + Convert.ToInt32(PRHYPhysicalEdustring) + Convert.ToInt32(PRHYCommercialArtstring) + Convert.ToInt32(PRHYEntrepreneurshipstring) );
                                        // HYTOT.Text = Convert.ToString(Convert.ToInt32(HYEngstring) + Convert.ToInt32(HYHindiBengalistring) + Convert.ToInt32(HYPhysicsstring) + Convert.ToInt32(HYChemistrystring) + Convert.ToInt32(HYBiologystring) + Convert.ToInt32(HYCompScistring) + Convert.ToInt32(HYMathstring) + Convert.ToInt32(HYPhysicalEdustring) + Convert.ToInt32(HYCommercialArtstring)  + Convert.ToInt32(PRHYEngstring) + Convert.ToInt32(PRHYHindiBengalistring) + Convert.ToInt32(PRHYPhysicsstring) + Convert.ToInt32(PRHYChemistrystring) + Convert.ToInt32(PRHYBiologystring) + Convert.ToInt32(PRHYCompScistring) + Convert.ToInt32(PRHYMathstring) + Convert.ToInt32(PRHYPhysicalEdustring) + Convert.ToInt32(PRHYCommercialArtstring) );
                                    }
                                    catch
                                    {
                    ...
                    else if (count == 9)
                    {
                        ...
                        if (Convert.ToString(Session["standard_id"]) == "XI Sc" || Convert.ToString(Session["standard_id"]) == "XI Com" || Convert.ToString(Session["standard_id"]) == "XI Arts") //Convert.ToString(Session["standard_id"]) == "XI Sc" || Convert.ToString(Session["standard_id"]) == "XI Com" ||
                        {
                            string reportPath = Server.MapPath("rpt11sci.rpt");
                           ...
                           // string HYEntrepreneurshipstring = "";
                            ...
                            for (i = 0; i < dsObjgrade.Tables[0].Rows.Count; i++)
                            {
                                ...
                                crystalReport.Load(Server.MapPath(string.Format("rpt11sci.rpt", i)));
                                stream1 = crystalReport.ExportToStream(ExportFormatType.PortableDocFormat);
                                files.Add(PrepareBytes(stream1));
                            }
                            Response.Clear();
