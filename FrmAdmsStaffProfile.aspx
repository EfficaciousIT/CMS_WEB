<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmAdmsStaffProfile.aspx.cs"
    MasterPageFile="~/MasterPage2.master" Inherits="FrmAdmsStaffProfile" Title="Staff Profile"
    Culture="es-MX" %>
...
<div class="content-header content-header1 pd-0">
        ...
        <li><a >School Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="FrmAdminStaffProfile.aspx">Staff Master</a></li>
                 ...
                 <div class="box box-orange">
                    <div class="box-header">
                     ...
                     <div class="form-group">
                            <div class="col-md-1 text-right" style="margin: 10px 0 0 0px;">
                       ...
                       <div class="col-md-1 text-right" style="margin: 10px 0 0 0px;">                              
                             ...
                             <asp:Label ID="lblDept" runat="server" Text="Department" CssClass="control-label"></asp:Label>
                            </div>
                        <div class="col-md-3">
                       ...
                       <div class="col-md-1 text-right" style="margin: 10px 0 0 0px; padding:0; font-size:12px;">                              
                            
                             <asp:Label ID="lblTeacherNm" runat="server" Text="Staff Name" CssClass="control-label"></asp:Label>
                            </div>
                        <div class="col-md-3">
                           
                             <asp:DropDownList ID="ddlTeacher"  runat="server" AutoPostBack="True" 
                                                            CssClass="form-control" onselectedindexchanged="ddlTeacher_SelectedIndexChanged" >
                                                        </asp:DropDownList>                                                                                                                   
                       </div>
                         </div>                       
                                        ...
                                        <div style="width: 900px; margin: 0 auto;">
                                            <center>
                                                ...
                                                <div class="profile-right">
                                                    ...
                                                    <div class="pleft-details">
                                                        <asp:Label ID="Label8" runat="server" Text="Academic Year" Font-Bold="False"></asp:Label>
                                                    </div>
                                                    <div class="pright-details">
                                                        <asp:Label ID="lblAcademicYear" runat="server" Font-Bold="False"></asp:Label>
                                                        <asp:DropDownList ID="ddlAcademicYear" runat="server" DataTextField="AcademicYear"
                                                            DataValueField='intAcademic_id' Width="160px" Enabled="False" >
                                                        </asp:DropDownList>
                                                    ...
                                                    <div class="pright-details">
                                                        <asp:Label ID="lblDesignation" runat="server" Font-Bold="False"></asp:Label>
                                                        <asp:DropDownList ID="ddlDesignation" runat="server" DataTextField="vchDesignation"
                                                            DataValueField='intDesignation_Id' Width="160px">
                                                        </asp:DropDownList>
