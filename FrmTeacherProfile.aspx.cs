...
public partial class FrmTeacherProfile : DBUtility
{
    ...
    protected void Detai()
    {
        ...
        {
            string query1 = "Execute dbo.usp_Profile @command='ShowTeacherProfile' ,@intUser_id='" + Session["User_id"] + "',@intSchool_id='" + Session["School_id"] + "',@intUserType_id='" + Session["UserType_id"] + "'";
            dsObj = sGetDataset(query1);
        }
        if (Convert.ToString(Session["strUserType"]) == "4")
        {
            string query1 = "Execute dbo.usp_Profile @command='ShowStaffProfile' ,@intUser_id='" + Session["User_id"] + "',@intSchool_id='" + Session["School_id"] + "',@intUserType_id='" + Session["UserType_id"] + "'";
            dsObj = sGetDataset(query1);
        }
    ...
    {
        string query1 = "Execute dbo.usp_Profile @command='ShowDepartment',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "',@intRole_id='" + Convert.ToString(Session["UserType_id"]) + "' ";
