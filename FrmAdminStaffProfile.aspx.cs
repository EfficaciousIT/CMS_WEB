...
public partial class FrmAdminStaffProfile : DBUtility
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ViewState["FilenameStaff"] = FileUpload1.PostedFile.FileName;
            }
    ...
    {
        string strQry = "usp_TeacherTransaction @type='selectAllStaff'";
    ...
    protected void Detai()
    {
        ...
        string query1 = "Execute dbo.usp_Profile @command='ShowStaffProfile' ,@intUser_id='" + st + "',@intSchool_id='" + Session["School_id"] + "'";
    ...
    protected void Editv()
    {
        ...
        try
        {
            string st1 = Request.QueryString["successMessage1"];
            TabContainer1.ActiveTabIndex = 0;
            string query1 = "Execute dbo.usp_Profile @command='ShowStaffProfile' ,@intUser_id='" + st1 + "',@intSchool_id='" + Session["School_id"] + "'";
    ...
    {
        string query1 = "Execute dbo.usp_Profile @command='ShowDepartmentStaff',@intSchool_id='" + Session["School_id"] + "' ";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                FileUpload1.SaveAs(Server.MapPath("images/Profile/Staffs/") + FileUpload1.FileName);
                string file = FileUpload1.PostedFile.FileName;

                StaffImg.ImageUrl = savePath + file;
    ...
    protected void submit(object sender, EventArgs e)
    {
        try
        {
            ...
            string filnmn1 = null;
            if (ViewState["FilenameStaff"] != null)
            {
                filnmn1 = ViewState["FilenameStaff"].ToString();
            }
            ...
            if (str != -1)
            {
                string display = "Staff Profile Saved!";
                MessageBox(display);
                Clear();
                fGrid();
            }
            ...
            {
                MessageBox("ooopppsss!Staff Profile failed");
    ...
    protected void Updateval(object sender, EventArgs e)
    {
        ...
        string instrquery1 = "Execute dbo.usp_Profile @command='UpdateStaff',@vchFirst_name='" + tfname + "',@vchMiddle_name='" + tmname + "',@vchLast_name='" + tlname + "',@vchPreferedSubject='" + tPSubject + "',@intsubject_id='" + tDepartnm + "',@intDesignation_Id='" + designa + "',@vchGender='" + gender + "',@dtDOB='" + tDobnm + "',@vchEmail='" + Emailvl + "',@vchHighestQualification='" + Qualif + "'," +
                                 ...
                                 "@intStaff_id='" + Convert.ToString(Session["intStaff_id"]) + "',@dtTimeToContact='" + TimeTocon + "'";
        int str = sExecuteQuery(instrquery1);
        ...
        if (str != -1)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Staff Profile Update Successfully!');window.location ='FrmAdminStaffProfile.aspx';", true);
        }
    ...
    {
        string strQrys = "exec usp_Profile  @command='FillDesignationStaff',@intDepartment='" + Convert.ToString(TextBox5.SelectedValue) + "',@intSchool_Id='" + Convert.ToString(Session["School_Id"]) + "'";
    ...
    protected void grvDetail_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            Session["intStaff_id"] = Convert.ToString(grvDetail.DataKeys[e.NewEditIndex].Value);
            string strQry = "";
            ...
            //dsObj = sGetDataset(strQry);
            string query1 = "Execute dbo.usp_Profile @command='EditStaff' ,@intUser_id='" + Convert.ToString(Session["intStaff_id"]) + "',@intSchool_id='" + Session["School_id"] + "',@intUserType_id='" + Session["UserType_id"] + "'";
            dsObj = sGetDataset(query1);
            if (dsObj.Tables[0].Rows.Count > 0)
            {
    ...
    protected void grvDetail_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            string strQry11 = "Execute dbo.usp_Profile @command='DeleteStaffPro',@intstaff_id='" + id + "',@intschool_id='" + Session["School_id"] + "',@vchDeleted_IP='" + DeleteIP + "',@intDeleted_id='" + Session["user_id"] + "'";
