<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmSMSTemplateMaster.aspx.cs" Inherits="frmSMSTemplateMaster" %>
                                            ...
                                            <table width="50%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="Left" width="50%">
                                                        <asp:Label ID="Label7" runat="server" Text="Template Id"></asp:Label>
                                                    </td>
                                                   <td align="left">
                                                        <asp:TextBox ID="txtTemplateId" runat="server" CssClass="input-blue" MaxLength="50" ToolTip="Enter Template No. Here "></asp:TextBox>
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtTemplateId"
                                                            FilterType="Numbers" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtTemplateName" runat="server" CssClass="input-blue" MaxLength="50" ToolTip="Enter Template Name Here "></asp:TextBox>
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" TargetControlID="txtTemplateName"
                                                            FilterType="Text" 
                                                            ValidChars=" " Enabled="True">
                                                        </asp:FilteredTextBoxExtender>
                                                    </td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td align="Left">
                                                        <asp:Label ID="Label1" runat="server" Text="Template Message"></asp:Label>
                                                    </td>
                                                    <td align="left">
                                                        <asp:TextBox ID="txtTemplateMessage" runat="server" CssClass="input-blue" Height="100" MaxLength="100" ToolTip="Enter Template Message Here "></asp:TextBox>
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="txtTemplateMessage"
                                                            FilterType="Text" 
                                                            ValidChars=" " Enabled="True">
                                                        </asp:FilteredTextBoxExtender>
                                                    </td>
