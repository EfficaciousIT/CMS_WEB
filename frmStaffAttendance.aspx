<%@ Page Title="Staff Attendance Report" Language="C#" MasterPageFile="~/MasterPage2.master"
    Culture="en-GB" AutoEventWireup="true" CodeFile="frmStaffAttendance.aspx.cs"
    Inherits="frmStaffAttendance" %>
...
<div class="content-header pd-0">       
        ...
        <li><a >Attendance <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>                  
            ...
            <li class="active1"><a href="frmStaffAttendance.aspx">Staff Attendance</a></li>
                            ...
                            <table width="100%" class="tabular">
                                        ...
                                        <div id="efficacious">
                                            <table width="90%" style="margin: 0 auto;">
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:DropDownList ID="ddlType" Style="width: 70%;" runat="server" AutoPostBack="True"
                                                    ...
                                                    <td align="left">
                                                        <asp:DropDownList ID="ddlDept" Style="width: 70%;" runat="server" AutoPostBack="True"
                                                    ...
                                                    <td align="left">
                                                        <asp:Label ID="lblTeacherNm" runat="server" Text="Staff Name" CssClass="textsize"></asp:Label>
                                                    </td>
                                                    <td align="left" CssClass="efficacious_send">
                                                    ...
                                                    <asp:ModalPopupExtender ID="modalPopup" runat="server" DynamicServicePath="" TargetControlID="UpdateProgress"
                                                           ...
                                                           <asp:UpdatePanel ID="pnlData" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate> 
                                                        <asp:DropDownList ID="ddlTeacher" Style="width: 70%;" runat="server" AutoPostBack="True" 
                                ...
                                <tr>
                                    <td align="left" colspan="4" width="100%">
                                        <asp:TabContainer ID="TabContainer2" CssClass="MyTabStyle" runat="server" ActiveTabIndex="0"
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td valign="top" width="80%" align="center">
                                                                <br />
                                                                <asp:Image ID="Image1" ImageUrl="~/images/LEGEND5.png" runat="server" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
                                                                                        ...
                                                                                        <td align="left">
                                                                                            <asp:DropDownList ID="drpselect" runat="server" CssClass="textsize">
                                                                                                ...
                                                                                                <asp:ListItem Text="Late" Value="Late"></asp:ListItem>
                                                                                                 <asp:ListItem Text="Outdoor Duty" Value="Onduty"></asp:ListItem>
                                                                                            </asp:DropDownList>
                                                                                        </td>
                                                                                        <td>
                                                                                            &#160;&#160;
                                                                ...
                                                                <asp:GridView ID="grvSummery" runat="server" AllowPaging="True" AllowSorting="True"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="Leave" HeaderText="Leave"></asp:BoundField>
                                                                         <asp:BoundField DataField="Onduty" HeaderText="Outdoor Duty"></asp:BoundField>
                                                        ...
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <td align="right" valign="top">
                                                                    <div id="Div1" class="efficacious" style="width: 90%;">
