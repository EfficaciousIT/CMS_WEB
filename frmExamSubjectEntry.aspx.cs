...
public partial class frmExamSubjectEntry : DBUtility
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Button1.Text == "Submit")
            {
                ...
                strQry = "exec [usp_Area] @command='checkExamSubjectExists',@vchSubjectName='" + Subject1 + "',@intStandard_id='" + intStandard_id + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "',@intAcademic_id='" + Convert.ToString(Session["AcademicID"]) + "'";
                ...
                {
                    itrque1 = "Execute dbo.usp_Area @command='InsertExamSubject',@vchSubjectName='" + Subject1 + "',@intStandard_id='" + intStandard_id + "',@fltinsertIP='" + instip + "',@intSchool_id='" + Session["School_id"] + "',@intInsert_By='" + Session["user_id"] + "',@intAcademic_id='" + Session["AcademicID"] + "'";
            ...
            else if (Button1.Text == "Update")
            {
                try
                {
                    ...
                    {
                        itrque1 = "Execute dbo.usp_Area @command='UpdateExamSubject',@vchSubjectName='" + Subject1 + "',@intStandard_id='" + intStandard_id + "',@IntUpdate_IP='" + Updateip + "',@intSchool_id='" + Session["School_id"] + "',@intUpdate_id='" + Session["user_id"] + "',@intExamSubject_id='" + SubId + "',@intAcademic_id='" + Session["AcademicID"] + "'";
    ...
    protected void SubReport_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            string strQry11 = "Execute dbo.usp_Area @command='DeleteexamSubject',@intSubject_id='" + id + "',@intschool_id='" + Session["School_id"] + "',@fltDeleteIP='" + DeleteIP + "',@intDeleted_by='" + Session["user_id"] + "'";
    ...
    protected void SubReport_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            string strQry = "exec dbo.usp_Area @command='EditExamSubject',@intExamSubject_id='" + id + "',@intschool_id='" + Session["School_id"] + "'";
            dsObj = sGetDataset(strQry);
            if (dsObj.Tables[0].Rows.Count > 0)
            {
                Button1.Text = "Update";
                hid1.Value = Convert.ToString(dsObj.Tables[0].Rows[0]["intExamSubject_id"]);
    ...
    protected void Stdrop1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (Stan1 == "A")
        {
            string Disquery = "Execute dbo.usp_Area @command='GridExamSubject',@intSchool_id='" + Session["School_id"] + "',@intAcademic_id='" + Session["AcademicID"] + "'";
            int grvDetail1 = sBindGrid(SubReport, Disquery);
            SubReport.AllowPaging = true;
        }
        else
        {
            string Disquery2 = "Execute dbo.usp_Area @command='GridExamSubjectStan',@intSchool_id='" + Session["School_id"] + "',@intStandard_id='" + Stan1 + "',@intAcademic_id='" + Session["AcademicID"] + "'";
