...
public partial class FrmAdmTeacherProfile : DBUtility
{
    ...
    {
        string strQrys = "exec usp_Profile  @command='FillDepartmentTeacher',@intDepartment='" + Convert.ToString(TextBox5.SelectedValue) + "',@intSchool_Id='" + Convert.ToString(Session["School_Id"]) + "'";
        sBindDropDownList(ddlDesignation, strQrys, "vchDepartment_name", "intDepartment");
    }
