<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Result_IX.aspx.cs" Inherits="Result_IX" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding-right: 0px" valign="middle">
                                                        <asp:DropDownList ID="ddlSTD" runat="server" AutoPostBack="True" CssClass="textsize"
                                                            ...
                                                            <asp:ListItem Value="9" Text="IX"></asp:ListItem>
                                                            <asp:ListItem Value="10" Text="X"></asp:ListItem>
