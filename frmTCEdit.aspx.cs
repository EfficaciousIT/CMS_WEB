...
public partial class frmTCEdit : DBUtility
{
            ...
            if (!IsPostBack)
            {
                if (Session["rptStudentdetail"] != null)
                {
                    ...
                    if (dsObj.Tables[0].Rows.Count > 0)
                    {
                        ...
                        txtAdmissionClass.Text = Convert.ToString(dsObj.Tables[0].Rows[0]["vchAdmissionclass"]);
    ...
    protected void view_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            vchlastclassfig = Convert.ToString(txtlastclassfig.Text).ToUpper(); ;
        }
        catch
        {
        ...
        try
        {
            ...
            vchpromotionHigherclassFig = Convert.ToString(txtHigherclassFig.Text).ToUpper();
        }
        catch
        {
        ...
        try
        {
            ...
            vchpromotionHigherclassWord = char.ToUpper(vchpromotionHigherclassWord[0]) + vchpromotionHigherclassWord.Substring(1);
        }
        catch
        {
    ...
    protected void Update_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string instrquery1 = "Execute dbo.usp_TCcertificate @command='UpdateTccertificate',@SRNo='" + SRNo + "',@AdmissionNo='" + AdmissionNo + "',@intStudent_id='" + Session["StudentID"] + "',@vchStudent_name='" + vchStudent_name + "',@vchFatherName='" + vchFatherName + "',@vchNationalty='" + vchNationalty + "',@vchSCST='" + vchSCST + "',@dtAdmission='" + dtAdmission + "'," +
                                  ...
                                  "@vchGeneralconduct='" + vchGeneralconduct + "',@dtApplication='" + dtApplication + "',@dtcertificateissue='" + dtcertificateissue + "',@vchreasonlevaning='" + vchreasonlevaning + "',@vchotherremark='" + vchotherremark + "',@intUpdate_id='" + Session["User_id"] + "',@vchUpdated_IP='" + GetSystemIP() + "',@intAcademic_id='" + Session["AcademicID"] + "',@BoardRegiNo='" + BoardRegiNo + "',@vchAdmissionclass='" + vchAdmissionclass + "'";
            ...
            {
                MessageBox("ooopppsss!TC certificate Update Failed");
