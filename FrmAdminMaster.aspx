<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="FrmAdminMaster.aspx.cs" Inherits="FrmAdminMaster" %>
        ...
        <asp:UpdatePanel ID="up2" runat="server">
            ...
            <asp:ModalPopupExtender ID="modalPopup" runat="server" TargetControlID="UpdateProgress1"
                ...
                <table>
                    ...
                    <tr>
                        <td align="left">
                            <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="3" Width="1015px"
                                CssClass="MyTabStyle">
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intAdmin_id" onrowdeleting="grvDetail_RowDeleting" onrowediting="grvDetail_RowEditing"  >
                                                                <Columns>
