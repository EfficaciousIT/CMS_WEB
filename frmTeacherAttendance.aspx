<%@ Page Title="Teacher Attendance Report" Language="C#" MasterPageFile="~/MasterPage2.master"
    Culture="en-GB" AutoEventWireup="true" CodeFile="frmTeacherAttendance.aspx.cs"
    Inherits="frmTeacherAttendance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-header pd-0">       
        ...
        <li><a >Attendance <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>                  
             <li class="active1"><a href="frmTeacherAttendance.aspx">Teacher Attendance</a></li>
                            ...
                            <table width="100%" class="tabular">
                                                ...
                                                <tr>
                                                    ...
                                                    <asp:ModalPopupExtender ID="modalPopup" runat="server" DynamicServicePath="" TargetControlID="UpdateProgress"
                                                           ...
                                                           <asp:UpdatePanel ID="pnlData" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate> 
                                                        <asp:DropDownList ID="ddlTeacher" Style="width: 90%;" runat="server" AutoPostBack="True" 
                                ...
                                <tr>
                                    <td align="left" colspan="4" width="100%">
                                        <asp:TabContainer ID="TabContainer2" CssClass="MyTabStyle" runat="server" ActiveTabIndex="3"
                ...
                <td align="right" width="100%" valign="top">
                    <table width="100%">
                        <tr>
                            <td>
                                <div class="excel">
                                   Export&nbsp;To&nbsp;Excel:<asp:ImageButton ID="ImgXls" Style="padding-top: 8px" CssClass="export" ToolTip="Export in Excel"
