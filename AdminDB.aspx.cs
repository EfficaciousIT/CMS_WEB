...
public partial class AdminDB : DBUtility
{
    ...
    public void FillNoticeDetails()
    {
        try
        {
            strQry = "usp_NewAdminDashboard @type='NoticeBoard',@SchoolId='" + Session["School_id"] + "',@AcademicID='" + Convert.ToString(Session["AcademicID"]) + "'";
            dsObj = sGetDataset(strQry);
            if (dsObj.Tables[0].Rows.Count > 0)
            {
                for (int k = 0; k < dsObj.Tables[0].Rows.Count; k++)
                {
                    ...
                    if (k == 10)
                    {
                        lblSubject11.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice11.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate11.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate11.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice11.Visible = true;
                    }
                    if (k == 11)
                    {
                        lblSubject12.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice12.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate12.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate12.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice12.Visible = true;
                    }
                    if (k == 12)
                    {
                        lblSubject13.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice13.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate13.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate13.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice13.Visible = true;
                    }
                    if (k == 13)
                    {
                        lblSubject14.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice14.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate14.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate14.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice14.Visible = true;
                    }
                    if (k == 14)
                    {
                        lblSubject15.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice15.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate15.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate15.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice15.Visible = true;
                    }
                    if (k == 15)
                    {
                        lblSubject16.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice16.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate16.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate16.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice16.Visible = true;
                    }
                    if (k == 16)
                    {
                        lblSubject17.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice17.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate17.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate17.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice17.Visible = true;
                    }
                    if (k == 17)
                    {
                        lblSubject18.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice18.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate18.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate18.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice18.Visible = true;
                    }
                    if (k == 18)
                    {
                        lblSubject19.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice19.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate19.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate19.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice19.Visible = true;
                    }
                    if (k == 19)
                    {
                        lblSubject20.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice20.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate20.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate20.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice20.Visible = true;
                    }
                    if (k == 20)
                    {
                        lblSubject21.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice21.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate21.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate21.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice21.Visible = true;
                    }
                    if (k == 21)
                    {
                        lblSubject22.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice22.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate22.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate22.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice22.Visible = true;
                    }
                    if (k == 22)
                    {
                        lblSubject23.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice23.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate23.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate23.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice23.Visible = true;
                    }
                    if (k == 23)
                    {
                        lblSubject24.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice24.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate24.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate24.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice24.Visible = true;
                    }
                    if (k == 24)
                    {
                        lblSubject25.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice25.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate25.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate25.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice25.Visible = true;
                    }
                    if (k == 25)
                    {
                        lblSubject26.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Subject"]);
                        lblNotice26.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Notice"]);
                        lblIssueDate26.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["Issue_Date"]);
                        lblEndDate26.Text = Convert.ToString(dsObj.Tables[0].Rows[k]["End_Date"]);
                        Notice26.Visible = true;
                    }
                }
            }
                ...
                if (drpStandard.Text == "All")
                {
                    ...
                    if (dsObj.Tables[0].Rows.Count > 0)
                    {
                        for (int i = 0; i <= dsObj.Tables[0].Rows.Count - 1; i++)
                        {
                            ...
                            // POST("http://e-smartsociety.com/submitsms.jsp?user=Efficas&key=1d9796cef6XX&mobile=" + strMobile1 + "&message=" + txtNotice.Text.Trim() + "&senderid=CMSBKP&accusage=1", "");
                            //POST("http://alerts.justnsms.com/api/web2sms.php?workingkey=A2cabcee227fa491ee050155a13485498&sender=CMSBKP&to=" + strMobile1 + "&message=" + txtNotice.Text.Trim() + "&senderid=CMSBKP&accusage=1", "");
                            POST("http://www.smsjust.com/sms/user/urlsms.php?username=Central Model school&pass=w_F@2R6g&senderid=CMSBKP&dest_mobileno=" + strMobile1.Trim() + "&msgtype=TXT&message=" + txtNotice.Text.Trim() + "&response=Y&dlttempid=1507163100574058180", "");
