<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="ResultPrimary.aspx.cs" Inherits="ResultPrimary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <%-- <button class="btn btn-sm btn-primary"  onclick="Img1_Click" id="printbutton" style="margin-bottom: 15px;" > Print</button>--%>
    ...
    <div class="tabular">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding-right: 0px" valign="middle">
                                                        <asp:DropDownList ID="ddlSTD" runat="server" AutoPostBack="True" CssClass="textsize"
                                                            ...
                                                            <asp:ListItem Value="13" Text="Nursery"></asp:ListItem>
                                                            <asp:ListItem Value="15" Text="Prep1"></asp:ListItem>
                                                            <asp:ListItem Value="16" Text="Prep2"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td align="center" valign="middle">
                             ...
                             <%--                       <td align="center" valign="middle">
                                                        <asp:Label ID="Label10" runat="server" Text="Gender" CssClass="textsize" Visible=false></asp:Label>
                                                    </td>
                                                    <td align="left" valign="middle">
...
<%--       <div class="col-md-12 col-xs-12 prl-5">
                <%--<div class="col-md-2 col-md-offset-1 col-xs-3">
           <div class="w-20 w-m-15">
                    <img src="img/cbse.png" class="img-responsive" alt="" />
                </div>
                <%--<div class="col-md-6 col-xs-6">
            <div class="w-60  w-m-70">
                    <div class="result-h">
                        <h2 style="font-size:21px">CENTRAL MODEL SCHOOL, BKP</h2>
                        <p>Affiliated to C.B.S.E (10 + 2) YEARS COURSE, NEW DELHI</p>
                        <h4>23, RIVER SIDE ROAD (Near Dhobighat), KOLKATA-120</h4>
                        <p>PH: 2592-1765 / 2593-5121 / FAX : 2594-9185</p>
                        <h2 style="font-size: 19px;">REPORT CARD</h2>
                        <h3 class="d-none">SESSION : <asp:Label ID="lblsession" runat="server"></asp:Label></h3>
                        <p>(Issued by school as per directives of Central Board of Secondary Education)</p>
                    </div>
                </div>
                 <%--<div class="col-md-2 col-xs-3">
            <div class="w-20 w-m-15">
                     <img src="img/central.png" class="img-responsive" alt=""/>
                </div>
                ...
                <asp:GridView ID="GridView2" runat="server" AllowSorting="True" AutoGenerateColumns="False" 
                                                 ...
                                                 <asp:GridView ID="GridView8" runat="server" AllowSorting="True" AutoGenerateColumns="False" 
                                                     ...
                                                     <Columns>
                                                         ...
                                                         <asp:BoundField  HeaderText="First Term" ReadOnly="True">
                                                         <HeaderStyle HorizontalAlign="Center" />
                                                         </asp:BoundField>
...
<table class="tab_result1 table table-hover mb-0">
                  <thead>
                      <tr>
                          <th>Subject</th>
                          <th style=" font-size: 11.2px;">First Term</th>                          
                          <th>Grade</th>
            ...
            <asp:GridView ID="GridView4" runat="server" AllowSorting="True" AutoGenerateColumns="False" 
                                                    ...
                                                    <asp:GridView ID="GridView9" runat="server" AllowSorting="True" AutoGenerateColumns="False" 
                                                     ...
                                                     <Columns>
                                                         ...
                                                         <asp:BoundField DataField="First Term" HeaderText="First Term" ReadOnly="True">
                                                         <HeaderStyle HorizontalAlign="Center" />
                                                         </asp:BoundField>
                                                          <asp:BoundField DataField="Final Term" HeaderText="Final Term" ReadOnly="True">
                                                         <HeaderStyle HorizontalAlign="Center" />
                                                         </asp:BoundField>
...
<%--        <div class="col-md-10  col-md-offset-1 col-xs-12  mt-15">           
            ...
            <h6 class=" text-left" style="padding-left: 36px;"></h6> 
             <h6 style=" border-top: 1px solid black;padding-top: 5px; text-align:center; margin:5px 0 0 0; font-size:11px;">  </h6>
            <h6 style=" text-align:center;  margin: 3px 0;"><strong>Address:</strong> 23,River Side Road NearDhobighat, Kol-120, <strong>PH:2592-1765/2593-5121 </strong>FAX:2594-9185 </h6>
            <h6 style=" text-align:center; margin: 3px 0; ">Website: www.cmsbarrakpore.com, Email: info@cmsbarrackpore.org</h6>
