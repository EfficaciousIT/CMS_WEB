...
public partial class FrmAdminProfile : DBUtility
{
    ...
    protected void Detai()
    {
        ...
        string query1 = "Execute dbo.usp_Profile @command='ShowAdminProfile' ,@intUser_id='" + Session["User_id"] + "',@intSchool_id='" + Session["School_id"] + "',@intUserType_id='" + Session["UserType_id"] + "'";
    ...
    protected void Editv()
    {
        ...
        try
        {
            ...
            Button3.Visible = false;
            TabContainer1.ActiveTabIndex = 0;
            string query1 = "Execute dbo.usp_Profile @command='ShowAdminProfile' ,@intUser_id='" + st1 + "',@intSchool_id='" + Session["School_id"] + "',@intUserType_id='" + Session["UserType_id"] + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                AdminImg.ImageUrl = savePath + file;
