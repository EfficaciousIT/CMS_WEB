<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="StandardMaster.aspx.cs" Inherits="StandardMaster" Title="E-Smarts - Student attendance management system, Fees management, School bus
    ...
    <style>
     ...
     <script type="text/javascript">
        function NoSpace(e) {
            ...
            alert(keycode);
            if (keycode == 32 || keycode == 17 || keycode == 46 || keycode == 45 || keycode == 64 || keycode == 60 || keycode == 62 || keycode == 33 || keycode == 35 || keycode == 36 || keycode == 37 || keycode == 94 || keycode == 38 || keycode == 42 || keycode == 40 || keycode == 41 || keycode == 43 || keycode == 44 || keycode == 95 || keycode == 59 || keycode == 58 || keycode == 39 || keycode == 34 || keycode == 63 || keycode == 47 || keycode == 91 || keycode == 92 || keycode == 93 || keycode == 123 || keycode == 124 || keycode == 125) {
...
<div class="content-header content-header1 pd-0">
        ...
        <li><a >School Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="frmStandardMaster.aspx">Standard Master</a></li>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                CssClass="table  tabular-table " PageSize="20" Width="50%" DataKeyNames="intstandardFee_id"
                                                                ...
                                                                <Columns>
                                                                 <asp:BoundField DataField="vchStandard_name" HeaderText="Standard" ReadOnly="True" />
                                                                    <asp:BoundField DataField="FeeAmount" HeaderText="FeeAmount" ReadOnly="True" />
                                                ...
                                                <table width="36%" style="text-align: right; margin:0 0 0 2%;">
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td align="justify">
                                                           <%-- <asp:TextBox ID="TextBox1" runat="server" CssClass="input-blue" MaxLength="75" AutoComplete="Off"></asp:TextBox>--%>
                                                    ...
                                                    <tr>
                                                        <td align="justify">
                                                            <asp:Label ID="Label2" runat="server" Text="Fee Amount"></asp:Label>
                                                        </td>
                                                        <td align="justify">
                                                            <asp:TextBox ID="txtFEE" runat="server" CssClass="input-blue" MaxLength="7" AutoComplete="Off" onkeypress="return validateNumber(event);"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
                                                        ...
                                                        <td align="left">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtFEE"
