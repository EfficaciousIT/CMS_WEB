<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true"
    CodeFile="FrmAdminStaffProfile.aspx.cs" Inherits="FrmAdminStaffProfile" Title="Staff Profile"
    Culture="es-MX" %>
                                        ...
                                        <div>
                                            <center>
                                                <table style="font-weight: bolder; width: 100%" align="center">
                                                    <tr>
                                                        <td rowspan="6">
                                                            <asp:Image ID="StaffImg" AlternateText="Image" ImageUrl="images/Sample%20Photo1.jpg"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            ...
                                                            <asp:TextBox ID="TextBox10" runat="server" CssClass="input-blue" Font-Names="Verdana"
                                                                ForeColor="Black" MaxLength="12" ValidationGroup="b" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;"></asp:TextBox>&nbsp;&nbsp;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" nowrap="nowrap">
                                                            ...
                                                            <asp:TextBox ID="TextBox12" runat="server" CssClass="input-blue" Font-Names="Verdana"
                                                                ForeColor="Black" MaxLength="10" ValidationGroup="b" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intStaff_id" onrowediting="grvDetail_RowEditing" OnRowDeleting="grvDetail_RowDeleting" >
                                                                <Columns>
