...
public partial class frmActivityMaster :  DBUtility
{
    ...
    protected void filldata()
    {
        try
        {
            ...
            string Disquery = "Execute dbo.usp_Area @command='GridActivities',@intSchool_id='" + Session["School_id"] + "',@intAcademic_id='" + Convert.ToString(Session["AcademicID"]) + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Button1.Text == "Submit")
            {
                ...
                strQry = "exec [usp_Area] @command='checkActivityExists',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@intSchool_id='" + Convert.ToString(Session["School_id"]) + "',@intAcademic_id='" + Convert.ToString(Session["AcademicID"]) + "'";
                ...
                {
                    itrque1 = "Execute dbo.usp_Area @command='InsertActivity',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@fltinsertIP='" + instip + "',@intSchool_id='" + Session["School_id"] + "',@intInsert_By='" + Session["user_id"] + "',@intAcademic_id='" + Session["AcademicID"] + "'";
            ...
            else if (Button1.Text == "Update")
            {
                try
                {
                    ...
                    {
                        itrque1 = "Execute dbo.usp_Area @command='UpdateActivities',@VchName='" + Name + "',@intStandard_id='" + intStandard_id + "',@IntUpdate_IP='" + Updateip + "',@intSchool_id='" + Session["School_id"] + "',@intUpdate_id='" + Session["user_id"] + "',@id='" + id + "',@intAcademic_id='" + Session["AcademicID"] + "'";
    ...
    protected void SubReport_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            string strQry11 = "Execute dbo.usp_Area @command='DeletetblActivities',@id='" + id + "',@intschool_id='" + Session["School_id"] + "',@fltDeleteIP='" + DeleteIP + "',@intDeleted_by='" + Session["user_id"] + "'";
    ...
    protected void SubReport_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            string strQry = "exec dbo.usp_Area @command='EditActivities',@id='" + id + "',@intschool_id='" + Session["School_id"] + "'";
            dsObj = sGetDataset(strQry);
            if (dsObj.Tables[0].Rows.Count > 0)
            {
                Button1.Text = "Update";
    ...
    protected void Stdrop1_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (query2 == "A")
            {
                string Disquery = "Execute dbo.usp_Area @command='GridActivities',@intSchool_id='" + Session["School_id"] + "',@intAcademic_id='" + Session["AcademicID"] + "'";
                int grvDetail1 = sBindGrid(SubReport, Disquery);
            ...
            {
                string Disquery2 = "Execute dbo.usp_Area @command='GridActivities',@intSchool_id='" + Session["School_id"] + "',@intStandard_id='" + query2 + "',@intAcademic_id='" + Session["AcademicID"] + "'";
