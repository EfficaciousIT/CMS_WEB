    ...
    protected void grdattendance_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else if (lnkbtn16.Text == "OD")
                {
                    lnkbtn16.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn16.ToolTip = "On Duty";
                }
                else
                {
           ...
           // ClsExportPdf exp = new ClsExportPdf();
            ...
            switch (TabContainer2.ActiveTabIndex)
            {
                ...
                case 3:
                    ...
                    exp.ExportGrid(grvSummery, "Attendance Summary Of Year " + ddlYear1.SelectedValue + " " + DateTime.Now.ToShortDateString(), Convert.ToInt32(ddlTeacher.SelectedValue), ddlTeacher.SelectedItem.Text, ddlDept.SelectedItem.Text, "", ddlType.SelectedValue, "Attendance Summary Of Year " + ddlYear1.SelectedValue);
