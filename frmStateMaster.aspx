<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="frmStateMaster.aspx.cs" Inherits="frmState" %>
...
<div class="content-header content-header1 pd-0">
        ...
        <li><a >School Master <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
            ...
            <li class="active1"><a href="frmStateMaster.aspx">State Master</a></li>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:GridView ID="grvDetail" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                DataKeyNames="intState_id" onrowdeleting="grvDetail_RowDeleting" onrowediting="grvDetail_RowEditing">
                                                                <Columns>
                                                ...
                                                <table width="36%" style="text-align: right;margin:0 0 0 2%;">
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            State Name</td>
                                                        <td align="left">
                                                                  <asp:TextBox ID="txtState" runat="server" AutoComplete="Off" 
