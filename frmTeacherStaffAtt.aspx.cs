...
public partial class frmTeacherStaffAtt : DBUtility
{
    ...
    public void FillStaffAllAttendace()
    {
        try
        {
    ...
    public void FillUserType()
    {
        ...
        {
            strQry = "";
            strQry = "exec [usp_FillDropDown] @type='TeacherStaffUserType'";
