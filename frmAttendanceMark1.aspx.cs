...
public partial class frmAttendanceMark1 : DBUtility
{
    ...
    protected void drpDivision_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            strQry = "usp_MarkAttendance @command='SendUserName',@intstanderd_id='" + drpStandard.SelectedValue.Trim() + "',@intdivision_id='" + drpDivision.SelectedValue.Trim() + "',@intschool_id='" + Convert.ToString(Session["School_id"]) + "',@intAcademicYear_id='" + Convert.ToString(Session["AcademicID"]) + "'";
            ...
            foreach (GridViewRow row in grdMarkAttendance.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkRow.Checked)
                    {
                        ...
                        string regId = this.grdMarkAttendance.DataKeys[row.RowIndex].Values[6].ToString();
                    ...
                    strQry = "usp_MarkAttendance @command='Insert',@intUserType_id='1',@intUser_id='0',@dtDate='" + strDate.Trim() + "',@inTime='" + strInTime.Trim() + "',@outTime='" + strOutTime.Trim() + "',@status='" + strAttendanceStatus.Trim() + "',@intSchool_Id='" + Convert.ToString(Session["School_id"]) + "',@intStudent_id='" + strStudent_id.Trim() + "',@intAcademicYear_id='" + Convert.ToString(Session["AcademicID"]) + "'";
            ...
            foreach (GridViewRow row in grdMarkAttendance.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    //{
                        ...
                        strStudentName = this.grdMarkAttendance.DataKeys[row.RowIndex].Values[2].ToString();
                        strMobileNo = this.grdMarkAttendance.DataKeys[row.RowIndex].Values[5].ToString();
                        strUserName=this.grdMarkAttendance.DataKeys[row.RowIndex].Values[3].ToString();
                        strPassword = this.grdMarkAttendance.DataKeys[row.RowIndex].Values[4].ToString();
