...
public partial class frmStaffAttendance : DBUtility
{
    ...
    public void FillDept()
    {
        try
        {
            ...
            strQry = "exec usp_FillDropDown @type='TrainingStaffDepartment',@intSchool_Id='" + Convert.ToString(Session["School_id"]) + "',@intUserType='" + Convert.ToString(ddlType.SelectedValue) + "'";
                ...
                foreach (DataRow dr in ((DataSet)Session["Table"]).Tables[0].Rows)
                {
                    ...
                    if (scheduledDate.Equals(Day_Date))
                    {
                        ...
                        else if (status == "Onduty")
                        {
                            ...
                            //lc.Text = @"<br/>" + "<font size=1 color=black>Present</font>" + "<br/>" + scheduled_LoginTime;
                            e.Cell.Controls.Add(lc);
                            e.Cell.ToolTip = "On Duty";
                            e.Cell.BackColor = System.Drawing.ColorTranslator.FromHtml("#1aff00");
    ...
    public void FillTeacher()
    {
        try
        {
            strQry = "exec usp_FillDropDown @type='GetStaff',@intDept_id='" + Convert.ToString(ddlDept.SelectedValue) + "',@intUserType='" + Convert.ToString(ddlType.SelectedValue) + "',@intSchool_Id='" + Convert.ToString(Session["School_id"]) + "'";
            sBindDropDownList(ddlTeacher, strQry, "Name", "intStaff_id");
    ...
    public void FillAllAttendace()
    {
        try
        {
            ...
            {
                strQry = "exec [usp_getAttendance]  @type='AllStaffAttendance' ,@year='" + Convert.ToString(ddlYear.SelectedValue) + "',@month='" + Convert.ToString(ddlMonth.SelectedValue) + "',@intsub='" + Convert.ToString(ddlDept.SelectedValue) + "',@intSchool_Id='" + Convert.ToString(Session["School_id"]) + "',@intUserType_id='" + Convert.ToString(ddlType.SelectedValue) + "'";
            }
            else
            {
                strQry = "exec [usp_getAttendance]  @type='SingleStaffAttendance' ,@year='" + Convert.ToString(ddlYear.SelectedValue) + "',@month='" + Convert.ToString(ddlMonth.SelectedValue) + "',@intsub='" + Convert.ToString(ddlDept.SelectedValue) + "',@intSchool_Id='" + Convert.ToString(Session["School_id"]) + "',@intUserType_id='" + Convert.ToString(ddlType.SelectedValue) + "',@intUser_id='" + Convert.ToString(ddlTeacher.SelectedValue) + "'";
            }
            dsObj = new DataSet();
            dsObj = sGetDataset(strQry);
            if (dsObj.Tables[0].Rows.Count > 0)
    ...
    protected void grdattendance_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else if (lnkbtn01.Text == "OD")
                {
                    lnkbtn01.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn01.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn01.Text == "L")
                ...
                else if (lnkbtn02.Text == "OD")
                {
                    lnkbtn02.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn02.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn02.Text == "L")
                ...
                else if (lnkbtn03.Text == "OD")
                {
                    lnkbtn03.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn03.ToolTip = "On Duty";
                } 
                else
                {
                    if (lnkbtn03.Text == "L")
                ...
                else if (lnkbtn04.Text == "OD")
                {
                    lnkbtn04.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn04.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn04.Text == "L")
                ...
                else if (lnkbtn05.Text == "OD")
                {
                    lnkbtn05.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn05.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn06.Text == "OD")
                {
                    lnkbtn06.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn06.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn06.Text == "L")
                ...
                else if (lnkbtn07.Text == "OD")
                {
                    lnkbtn07.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn07.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn07.Text == "L")
                ...
                else if (lnkbtn08.Text == "OD")
                {
                    lnkbtn08.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn08.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn08.Text == "L")
                ...
                else if (lnkbtn09.Text == "OD")
                {
                    lnkbtn09.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn09.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn09.Text == "L")
                ...
                else if (lnkbtn10.Text == "OD")
                {
                    lnkbtn10.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn10.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn10.Text == "L")
                ...
                else if (lnkbtn11.Text == "OD")
                {
                    lnkbtn11.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn11.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn11.Text == "L")
                ...
                else if (lnkbtn12.Text == "OD")
                {
                    lnkbtn12.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn12.ToolTip = "On Duty";
                }
                else
                {
                    if (lnkbtn12.Text == "L")
                ...
                else if (lnkbtn13.Text == "OD")
                {
                    lnkbtn13.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn13.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn14.Text == "OD")
                {
                    lnkbtn14.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn14.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn15.Text == "OD")
                {
                    lnkbtn15.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn15.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn17.Text == "OD")
                {
                    lnkbtn17.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn17.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn18.Text == "OD")
                {
                    lnkbtn18.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn18.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn19.Text == "OD")
                {
                    lnkbtn19.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn19.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn20.Text == "OD")
                {
                    lnkbtn20.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn20.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn21.Text == "OD")
                {
                    lnkbtn21.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn21.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn22.Text == "OD")
                {
                    lnkbtn22.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn22.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn23.Text == "OD")
                {
                    lnkbtn23.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn23.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn24.Text == "OD")
                {
                    lnkbtn24.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn24.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn25.Text == "OD")
                {
                    lnkbtn25.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn25.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn26.Text == "OD")
                {
                    lnkbtn26.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn26.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn27.Text == "OD")
                {
                    lnkbtn27.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn27.ToolTip = "On Duty";
                }
                else
                {
                ...
                else if (lnkbtn28.Text == "OD")
                {
                    lnkbtn28.ForeColor = System.Drawing.Color.BlueViolet;
                    lnkbtn28.ToolTip = "On Duty";
                }
                else
                {
                ...
                if (ddlMonth.SelectedValue == "2")
                {
                    try
                    {
                        ...
                        else if (lnkbtn29.Text == "OD")
                        {
                            lnkbtn29.ForeColor = System.Drawing.Color.BlueViolet;
                            lnkbtn29.ToolTip = "On Duty";
                        }
                        else
                        {
                ...
                if (ddlMonth.SelectedValue == "4" || ddlMonth.SelectedValue == "6" || ddlMonth.SelectedValue == "9" || ddlMonth.SelectedValue == "11")
                {
                    ...
                    else if (lnkbtn30.Text == "OD")
                    {
                        lnkbtn30.ForeColor = System.Drawing.Color.BlueViolet;
                        lnkbtn30.ToolTip = "On Duty";
                    }
                    else
                    {
                ...
                if (ddlMonth.Text == "1" || ddlMonth.Text == "3" || ddlMonth.Text == "5" || ddlMonth.Text == "7" || ddlMonth.Text == "8" || ddlMonth.Text == "10" || ddlMonth.Text == "12")
                {
                    ...
                    else if (lnkbtn31.Text == "OD")
                    {
                        lnkbtn31.ForeColor = System.Drawing.Color.BlueViolet;
                        lnkbtn31.ToolTip = "On Duty";
                    }
                    else
                    {
